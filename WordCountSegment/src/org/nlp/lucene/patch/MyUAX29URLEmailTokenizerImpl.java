...
public final class MyUAX29URLEmailTokenizerImpl implements StandardTokenizerInterface {
   ...
   */
  public MyUAX29URLEmailTokenizerImpl(java.io.Reader in) {
    this.zzReader = in;
  }
  ...
  public int getNextToken() throws java.io.IOException {
    ...
    while (true) {
      ...
      //System.out.println("zzMarkedPos:"+zzMarkedPos+" c:"+c+" &"+(char)c+"& "+ub.toString());
     // System.out.println("zzMarkedPosL:"+zzMarkedPosL+" zzStartRead "+zzStartRead);
    ...
    //  zzCurrentPosL = zzCurrentPos = zzStartRead = zzMarkedPosL;
	    ...
	    if (ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS 
	    	 ...
	    	 zzCurrentPosL = zzCurrentPos  = zzMarkedPosL;
	    }
	   /* else if(ub==Character.UnicodeBlock.HALFWIDTH_AND_FULLWIDTH_FORMS){
	    ...
	    //System.out.println("zzStartRead "+zzStartRead);
      ...
      zzForAction: {
        while (true) {
          ...
          /*  System.out.println("--- zzStartRead "+zzStartRead);
            System.out.println("--- zzAtEOF "+zzAtEOF);
            System.out.println("--- zzCurrentPos "+zzCurrentPos);
            System.out.println("--- zzMarkedPos "+zzMarkedPos);
            System.out.println("--- zzEndReadL "+zzEndReadL);*/
         ...
         // System.out.println("zzInput "+zzInput+" "+(char) zzInput);
          
        //  System.out.println("zzBufferL "+zzBufferL[zzBufferL.length-2]+zzBufferL[zzBufferL.length-1]);
  ...
  /*    System.out.println("zzStartRead "+zzStartRead);
      ...
      System.out.println("zzCurrentPos "+zzCurrentPos);
      System.out.println("zzEndReadL "+zzEndReadL);
      System.out.println("zzEndRead "+zzEndRead);
      System.out.println("zzMarkedPosL "+zzMarkedPosL);*/
     // System.out.println("zzAction "+(zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]));
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 6:
	        { 
	        	  ...
	        	  c = zzBufferL[n];
	        	  ub = Character.UnicodeBlock.of(c);
	        		// System.out.println(zzStartRead+" "+zzMarkedPos+" "+zzCurrentPosL+"::"+zzBufferL[zzCurrentPosL]);
	        	 // System.out.println(c+" MyUAX29URLEmailTokenizerImpl.getNextToken()"+" 4431  "+ub.toString());
	        	    if (( zzMarkedPos!=zzEndRead) 
	        	    		&& (ub == Character.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS || ub==Character.UnicodeBlock.CJK_COMPATIBILITY)
	        	    	...
	        	    	/*zzStartRead=zzMarkedPos;
	        	    	System.out.println(zzStartRead+"="+zzMarkedPos);*/
        ...
        case 22: break;
        default: 
         /* System.out.println("MyUAX29URLEmailTokenizerImpl.getNextToken() "+zzInput);
       	  System.out.println("MyUAX29URLEmailTokenizerImpl.getNextToken() "+YYEOF);
       	  System.out.println("MyUAX29URLEmailTokenizerImpl.getNextToken() "+zzStartRead);
       	  System.out.println("MyUAX29URLEmailTokenizerImpl.getNextToken() "+zzCurrentPos);*/
