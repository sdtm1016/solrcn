...
public class CoreAdminRequest extends SolrRequest {
  ...
  public static class MergeIndexes extends CoreAdminRequest {
    ...
    public String[] getSrcCores() {
      return srcCores;
    }
    
    public void setSrcCores(String[] srcCores) {
    ...
    public SolrParams getParams() {
      ...
      params.set(CoreAdminParams.CORE, core);
      if (indexDirs != null) {
        params.set(CoreAdminParams.INDEX_DIR, indexDirs);
        
      }
      if (srcCores != null) {
        params.set(CoreAdminParams.SRC_CORE, srcCores);
      }
      return params;
    }
  }
  ...
  public static class Unload extends CoreAdminRequest {
    ...
    public Unload(boolean deleteIndex, boolean deleteDataDir,
  ...
  public static CoreAdminResponse reloadCore(String name, SolrServer server)
      throws SolrServerException, IOException {
  ...
  public static CoreAdminResponse unloadCore(String name, SolrServer server)
      throws SolrServerException, IOException {
  ...
  public static CoreAdminResponse getStatus(String name, SolrServer server)
      throws SolrServerException, IOException {
    CoreAdminRequest req = new CoreAdminRequest();
    req.setCoreName(name);
  ...
  public static CoreAdminResponse createCore(String name, String instanceDir,
      SolrServer server, String configFile, String schemaFile)
      throws SolrServerException, IOException {
  ...
  public static CoreAdminResponse persist(String fileName, SolrServer server)
      throws SolrServerException, IOException {
  ...
  public static CoreAdminResponse mergeIndexes(String name, String[] indexDirs,
      String[] srcCores, SolrServer server) throws SolrServerException,
      IOException {
    MergeIndexes req = new MergeIndexes();
    req.setCoreName(name);
    req.setIndexDirs(indexDirs);
    req.setSrcCores(srcCores);
    return req.process(server);
  }
}
