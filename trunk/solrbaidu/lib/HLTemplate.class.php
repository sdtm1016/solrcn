...
//		HLMsg::RevertPost(1);
	 ...
	 * Example:
	 * <code>
	 * HLTemplate::AddCss('/css/main.css');
	 * HLTemplate::AddCss(array('/css/Mypage.css', '/css/style.css'));
	 * </code>
	 * 
	 * @param string|array $css			文件路径
	 * @param boolean $mtime			是否带时间戳
	 * @return void
	 * @see HLTemplate::CssToString()		
	 */
	 ...
	 * Example:
	 * <code>
	 * HLTemplate::AddJs('/js/prototype.js');
	 * HLTemplate::AddJs(array('/js/jQuery.js', '/js/jQuery.calc.js'));
	 * </code>
	 *
	 * @param string|array $js			文件路径
	 * @param boolean $mtime			是否带时间戳
	 * @return void
	 * @see HLTemplate::JsToString()
	 */
	 ...
	 * Example:
	 * <code>
	 * HLTemplate::AddJsVars("target", 6);
	 * HLTemplate::AddJsVars(array("target" => 7, "next" => true, "list" => array( 1, 2, 3, 4)));
	 * </code>
	 *
	 ...
	 * Example:
	 * <code>
	 * HLTemplate::AddJsCode('var a = 111;');
	 * HLTemplate::AddJsCode(array('var data = {"json": 1};', 'alert('Hello World!')'));
	 * </code>
	 * 
	 ...
	 * );
	 * HLTemplate::AddMeta($meta, true);
	 * HLTemplate::AddMeta(array('name' => 'stencil', 'content'=> 'PGLS000022'));
	 * </code>
	 * 
	 * @param array $metas			键值对
	 * @param boolean $multi		是否是二维数组
	 * @return void
	 * @see HLTemplate::MetaToString()
	 */
