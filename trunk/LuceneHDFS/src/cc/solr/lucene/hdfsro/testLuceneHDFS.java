...
public class testLuceneHDFS {
	...
	public static void Index() {
		...
		cc.solr.lucene.store.hdfs.HdfsDirectory directory = null;
		try {
			directory = new cc.solr.lucene.store.hdfs.HdfsDirectory("hdfs://master:9000/user/KmaDou/index2");
	...
	public static void main(String[] args) throws IOException {
		...
		cc.solr.lucene.store.hdfs.HdfsDirectory directory = new cc.solr.lucene.store.hdfs.HdfsDirectory("hdfs://master:9000/user/KmaDou/index2");
		IndexReader reader;
		try {
