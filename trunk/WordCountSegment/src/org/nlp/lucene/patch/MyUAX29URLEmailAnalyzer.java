 ...
 * </p>
 */
public final class MyUAX29URLEmailAnalyzer extends StopwordAnalyzerBase {
  ...
  public MyUAX29URLEmailAnalyzer(Version matchVersion, CharArraySet stopWords) {
   ...
   * <a href="#version">above</a>}
   */
  public MyUAX29URLEmailAnalyzer(Version matchVersion) {
  ...
  public MyUAX29URLEmailAnalyzer(Version matchVersion, Reader stopwords) throws IOException {
  ...
  protected TokenStreamComponents createComponents(final String fieldName, final Reader reader) {
    final MyUAX29URLEmailTokenizer src = new MyUAX29URLEmailTokenizer(matchVersion, reader);
    ...
    return new TokenStreamComponents(src, tok) {
        ...
        protected void setReader(final Reader reader) throws IOException {
          src.setMaxTokenLength(MyUAX29URLEmailAnalyzer.this.maxTokenLength);
