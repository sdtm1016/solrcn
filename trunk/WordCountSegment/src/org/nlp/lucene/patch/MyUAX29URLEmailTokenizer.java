...
public final class MyUAX29URLEmailTokenizer extends Tokenizer {
   ...
   */
  public MyUAX29URLEmailTokenizer(Version matchVersion, Reader input) {
    super(input);
   ...
   */
  public MyUAX29URLEmailTokenizer(Version matchVersion, AttributeSource source, Reader input) {
    super(source, input);
    this.scanner = getScannerFor(matchVersion, input);
  }
   ...
   */
  public MyUAX29URLEmailTokenizer(Version matchVersion, AttributeFactory factory, Reader input) {
    super(factory, input);
    this.scanner = getScannerFor(matchVersion, input);
  }
...
//      return new MyUAX29URLEmailTokenizerImpl(input);
...
//    }
  ...
  public final boolean incrementToken() throws IOException {
   ...
   //   System.out.println("MyUAX29URLEmailTokenizer.incrementToken()"+termAtt);
...
/*  @Override
  public final boolean incrementToken() throws IOException {
    ...
    while(true) {
      ...
      if(tokenType==MyUAX29URLEmailTokenizerImpl.IDEOGRAPHIC_TYPE){
