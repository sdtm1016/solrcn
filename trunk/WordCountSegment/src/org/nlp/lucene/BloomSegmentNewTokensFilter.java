...
public class BloomSegmentNewTokensFilter extends TokenFilter {
	...
	public BloomSegmentNewTokensFilter(TokenStream input) {
		super(input);
	...
	public boolean incrementToken() throws IOException {
		...
		if (tokenIter == null || !tokenIter.hasNext()) {
			if (input.incrementToken()) {
				...
				tokenBuffer = wordSegmenter.getNewTokens(termAtt.toString());				
